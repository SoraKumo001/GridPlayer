...
namespace GridPlayer
{
    public class AppStatus : INotifyPropertyChanged
    {
        ...
        public int DecodePixelWidth { get { return decodePixelWidth; } set { if (decodePixelWidth != value) { decodePixelWidth = value; OnPropertyChanged(); } } }
